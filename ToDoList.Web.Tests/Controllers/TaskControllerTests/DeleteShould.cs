...
namespace ToDoList.Web.Tests.Controllers.TaskControllerTests
{
    ...
    class DeleteShould
    {
        ...
        public void CallTaskServiceFindTaskById_OnlyOnce()
        {
            ...
            //Act
            controller.Delete(taskId.ToString());
        ...
        public void ReturnDefaultView()
        {
            ...
            //Act&Assert
            controller.WithCallTo(c => c.Delete(taskId.ToString())).ShouldRenderDefaultView();
        }
        ...
        public void ReturnDefaultView_WithCorrectModel()
        {
            ...
            //Act&Assert
            controller.WithCallTo(c => c.Delete(taskId.ToString()))
